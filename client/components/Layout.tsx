...
export default function Layout({ children }: LayoutProps) {
  ...
  const navigation = [
    ...
    { name: t("images"), href: "/images", icon: Image },
    { name: t("videos"), href: "/videos", icon: Video },
    { name: t("models"), href: "/3d-models", icon: Box },
    { name: t("illustrations"), href: "/icons", icon: Sparkles },
  ];

  const userNavigation = [
    { name: t("profile"), href: "/profile", icon: User },
    { name: t("contributers"), href: "/contributor", icon: Upload },
    { name: t("settings"), href: "/settings", icon: Settings },
  ];

  const aiNavigation = [
    { name: t("ai_tools"), href: "/generate-ai", icon: Zap, featured: true },
