...
export type Language = "Eng" | "Rus" | "Tkm" | "Kz" | "Uz" | "Kg" | "Tajik";
...
const translations: Record<Language, Record<string, string>> = {
  Eng: {
    ...
    "hero.subtitle":
      "Explore millions of high-quality images, videos, 3D models, and icons from talented creators across Central Asia",
  ...
  Rus: {
    ...
    "hero.subtitle":
      "Исследуйте миллионы высококачественных изображений, видео, 3D моделей и иконок от талантливых авторов Центральной Азии",
  ...
  Tkm: {
    ...
    "hero.subtitle":
      "Orta Aziýanyň zehinli döredijilerinden millionlarça ýokary hilli suratlar, wideolar, 3D modeller we bellikler barlaň",
  ...
  Kz: {
    ...
    "hero.subtitle":
      "Орталық Азияның талантты авторларынан миллиондаған жоғары сапалы суреттер, видеолар, 3D модельдер мен белгішелерді зерттеңіз",
  ...
  Uz: {
    ...
    "hero.subtitle":
      "Markaziy Osiyoning iqtidorli ijodkorlaridan millionlab yuqori sifatli rasmlar, videolar, 3D modellar va belgilarni o'rganing",
